                  ...
                  <tr>
                        ...
                        <!--皮肤第一列-->
                          <table class="skinboxfont" width="100%"  border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr class="<?php echo $arrSkin['defSkin']?>">
                                  <td width="20">&nbsp;</td>
                                  <td width="100">
                                  <?php if($arrSkin['preview']!="../images/skin.jpg"){?>
                                  <a href="<?php echo $arrSkin['preview']?>" target="_blank" title="Zoom"><img src="<?php echo $arrSkin['preview']?>" alt="" border="0" class="skinimg" width="100" height="100"/></a>
                                  <?php }else{ ?>
                                  <img src="<?php echo $arrSkin['preview']?>" alt="" border="0" class="skinimg" width="100" height="100"  title="NoPreview"/>
                                  <?php } ?>
                                  </td>
                                  <td width="20">&nbsp;</td>
                                  <td>
                        ...
                        <!--皮肤第二列-->
                          <table class="skinboxfont" width="100%"  border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr class="<?php echo $arrSkin1['defSkin']?>">
                                  ...
                                  <?php if($arrSkin1['preview']!="../images/skin.jpg"){?>
                                  <a href="<?php echo $arrSkin1['preview']?>" target="_blank" title="Zoom"><img src="<?php echo $arrSkin1['preview']?>" alt="" border="0" class="skinimg" width="100" height="100"/></a>
                                  <?php }else{ ?>
                                  <img src="<?php echo $arrSkin1['preview']?>" alt="" border="0" class="skinimg" width="100" height="100" title="NoPreview"/>
                                  <?php } ?>
                                  </td>
                                  <td width="20">&nbsp;</td>
                                  <td>
                        ...
                        <table class="skinboxfont" width="100%"  border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr class="<?php echo $arrSkin2['defSkin']?>">
                                  <td width="20">&nbsp;</td>
                                  <td width="100">
                                  <?php if($arrSkin2['preview']!="../images/skin.jpg"){?>
                                  <a href="<?php echo $arrSkin2['preview']?>"  target="_blank" title="Zoom"><img src="<?php echo $arrSkin2['preview']?>" alt="" border="0" class="skinimg" width="100" height="100"/></a>
                                  <?php }else{ ?>
                                  
                                  <img src="<?php echo $arrSkin2['preview']?>" alt="" border="0" class="skinimg" width="100" height="100" title="NoPreview"/>
                                  <?php } ?>
                                  </td>
                                  <td width="20">&nbsp;</td>
                                  <td>
