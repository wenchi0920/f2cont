...
if($GoBind->photogetPhotoList($bbb_user_key,$page,$bbb_per_page,$bbb_size)) {	
...
<?php
	...
	<div style="text-align:center;clear:both;" align="center">当前显示[<?php echo count($GoBind->photo_list)?>]幅图，共[<?php echo $GoBind->photo_total?>]幅图</div>
	<div>
		<div class="pageContent" style="OVERFLOW: hidden; LINE-HEIGHT: 140%; HEIGHT: 18px; TEXT-ALIGN: right">
