<?
# 禁止直接访问该页面
if (basename($_SERVER['PHP_SELF']) == "keywords_list.inc.php") {
    ...
    <div class="box">
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td bgcolor="#FFFFFF" >
            <div class="contenttitle"><img src="images/content/keyword.gif" width="12" height="11">
              <?=$title?>
              <div class="page">
                <?view_page($page_url)?>
              </div>
	...
	?>
                <tr class="subcontent-input" onMouseOver="this.style.backgroundColor='<?=$cfg_mouseover_color?>'" onMouseOut="this.style.backgroundColor=''">
                  ...
                  <td width="20%" nowrap class="subcontent-td">
                    <?if ($fa['linkImage']!=""){?>
                    <img src="../attachments/<?=$fa['linkImage']?>">
                    <?}else{?>
                    &nbsp;
                    <?}?>
                  </td>
