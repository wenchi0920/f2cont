<?
# 禁止直接访问该页面
if (basename($_SERVER['PHP_SELF']) == "filters_add.inc.php") {
            ...
            <div class="subcontent">
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr class="subcontent-input">
                  ...
                  <td width="90%">
                    <select name="category">
                      <option value="1" <?=($category==1)?"selected":""?>>
                      <?=$strFiltersCategory1?>
                      </option>
                      <option value="2" <?=($category==2)?"selected":""?>>
                      <?=$strFiltersCategory2?>
                      </option>
                      <option value="3" <?=($category==3)?"selected":""?>>
                      <?=$strFiltersCategory3?>
                      </option>
                      <option value="4" <?=($category==4)?"selected":""?>>
                      <?=$strFiltersCategory4?>
                      </option>
                    </select>
                  </td>
                ...
                <tr>
                  ...
                  <td width="90%">
                    <input name="name" id="name" class="textbox" type="TEXT" size=50 maxlength=100 value="<?=$name?>">
                  </td>
                </tr>
              </table>
            </div>
