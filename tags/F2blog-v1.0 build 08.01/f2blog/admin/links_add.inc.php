<?
# 禁止直接访问该页面
if (basename($_SERVER['PHP_SELF']) == "links_add.inc.php") {
...
function onclick_update(form) {
	...
	if (isNull(form.blogUrl, '<?=$strErrNull?>')) return false;
            ...
            <div class="subcontent">
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="90%">
                    <input name="blogUrl" id="blogUrl" class="textbox" type="TEXT" size=50 maxlength=50 value="<?=$blogUrl?>">
                  </td>
                </tr>
              </table>
            </div>
