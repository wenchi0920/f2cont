<?
# 禁止直接访问该页面
if (basename($_SERVER['PHP_SELF']) == "categories_add.inc.php") {
            ...
            <div class="subcontent">
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr class="subcontent-input">
                  ...
                  <td width="90%">
                    <?get_category_parent("parent",$parent,"style=\"width:280px;font-size:12px;\"")?>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="90%">
                    <input name="cateTitle" id="cateTitle" class="textbox" type="TEXT" size=50 maxlength=100 value="<?=$cateTitle?>">
                  </td>
                </tr>
                <tr>
                  <td width="10%" nowrap>
                  ...
                  <td width="90%">
                    <input name="url" id="url" class="textbox" type="TEXT" size=50 maxlength=100 value="<?=$url?>">
                  </td>
                </tr>
              </table>
            </div>
