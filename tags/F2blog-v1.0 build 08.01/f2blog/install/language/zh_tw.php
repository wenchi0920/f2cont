...
$strInstallInfo="<p>".$strWelcome."，本安裝程序將幫助您把F2Blog完整地安裝在您的服務器內。請您先確認以下安裝配置: </p>    <ul>      <li>PHP版本為4.1及以上 </li>      <li>MySQL版本為4.0及以上 </li>      <li>MySQL 主機名稱/IP 地址 </li>      <li>MySQL 用戶名和密碼 </li>      <li>MySQL 數據庫名稱 (如果沒有創建新數據庫的權限) </li>      <li>./backup 備份目錄權限為 0777 (Linix系統) </li>      <li>./attachments 附件目錄權限為 0777 (Linix系統) </li>      <li> ./cache 緩存目錄權限為 0777 (Linix系統)</li>      <li>./include/config.php 數據庫連接設置文件權限為 0777 (Linix系統) </li>    </ul>    <p>如果您無法確認以上的配置信息, 請與您的服務商聯繫.</p>";
...
$strMixMysql="您的MySQL版本低於4.0, 由於程序沒有經過此平台的測試, 建議您換 MySQL4或MySQL5 的數據庫服務器.";
