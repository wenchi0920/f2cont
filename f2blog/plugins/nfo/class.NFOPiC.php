...
class NFOPiC
{
	 ...
	 */
	var $config  =  array(
		'server_save_dir' => '',          //  存放已经创建完成的 NFO 文件的图片的目录
		'browser_pic_dir' => '',   //  使用浏览器浏览图片时，图片存放的相对目录
		'codetable-dir'   => "../plugins/nfo/config/",           //  ISO-8859-2 UNICODE字符集的文存放的目录
		'nfo-dir'         => "",       //  NFO 文存放的目录
		'font-dir'        => "../plugins/nfo/config/",           //  字体存放的目录
		'nfo_name'        => '',                    //  NFO 文件的名称（支持带目录路径）例如：c:/rls/aaa.nfo 或者 
		'pic_name'        => '',                    //  图片名称
		...
		'top'             => 0,                     //  上方的边距
		'left'            => 0,                     //  左方的边距
		'fontcolor'       => '#000000',          //  文字的颜色(R，G，B), 例如：'000033' / array(0,0,51)
//		'fontcolor'       => array(255,255,255),          //  文字的颜色(R，G，B), 例如：'000033' / array(0,0,51)
		'bgcolor'         => '#ffffff',    //  背景颜色(R，G，B), 例如：'000033' / array(0,0,51)
