<?
# 禁止直接访问该页面
if (basename($_SERVER['PHP_SELF']) == "modules_order.inc.php") {
        ...
        <tr>
          ...
          <td bgcolor="#FFFFFF" >
            ...
            <div class="subcontent">
			  ...
			  <td width="10%" align="center"><?=$strCategoryOrderNo?></td>
			  <td width="30%"><?=$strModName?></td>
			  <td width="30%"><?=$strModuleDescription?></td>
			</tr>
			...
			?>
				<tr>
				  <td width="10%" align="center">
					...
					<input name="orderNo[]" id="orderNo" class="textbox" type="TEXT" size=2 maxlength=5 value="<?=$arr_parent[$i]['orderNo']?>" onKeyPress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false; "></td>
				  <td width="30%"><?=$arr_parent[$i]['name']?></td>
				  <td width="30%"><?=$modTitle?></td>
				</tr>
			<?}?>
              </table>
            </div>
