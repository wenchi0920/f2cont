<?
# 禁止直接访问该页面
if (basename($_SERVER['PHP_SELF']) == "attachments_add.inc.php") {
...
function onclick_update(form) {
	if (isNull(form.myfile, '<?=$strErrNull?>')) return false;
            ...
            <div class="subcontent">
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr class="subcontent-input">
                  ...
                  <td width="90%">
                    <input name="myfile" id="myfile" class="filebox" type="file" size=50 maxlength=20>
                  </td>
                </tr>
              </table>
            </div>
