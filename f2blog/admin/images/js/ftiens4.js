...
//constant data
  ...
  this.iconSrc = "images/menu/ftv2folderopen.gif"
...

{
  ...
  if (level>0)
...

    {
      ...
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='images/menu/ftv2mlastnode.gif' width=16 height=22 border=0></a>")

      leftSide = leftSide + "<img src='images/menu/ftv2blank.gif' width=16 height=22>"
...

    {
      ...
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='images/menu/ftv2mnode.gif' width=16 height=22 border=0></a>")

      leftSide = leftSide + "<img src='images/menu/ftv2vertline.gif' width=16 height=22>"
...

  {
    ...
    if (folder.nodeImg)
      ...
      if (folder.isLastNode)
        ...
        folder.nodeImg.src = "images/menu/ftv2mlastnode.gif"

      else

	    folder.nodeImg.src = "images/menu/ftv2mnode.gif"

    folder.iconImg.src = folder.iconSrc; // "images/menu/ftv2folderopen.gif"
...

  {
    ...
    if (folder.nodeImg)
      ...
      if (folder.isLastNode)
        ...
        folder.nodeImg.src = "images/menu/ftv2plastnode.gif"

      else

	    folder.nodeImg.src = "images/menu/ftv2pnode.gif"

    folder.iconImg.src = folder.iconSrc; // "images/menu/ftv2folderclosed.gif"
...
function outputFolderLink()
{
	if (this.hreference!="#"){
		...
		doc.write("<a class=tree href='javascript:clickOnFolder("+this.id+")'>")
	}
...

{
  ...
  //this.iconSrc = "images/menu/ftv2doc.gif"
...

{
  ...
  if (level>0)
...

    {
      ...
      this.renderOb(leftSide + "<img src='images/menu/ftv2lastnode.gif' width=16 height=22>")
...

    {
      ...
      this.renderOb(leftSide + "<img src='images/menu/ftv2node.gif' width=16 height=22>")
...

{
...

  {
    ...
    fullLink = "'"+linkData+"' target=\"blank\""
