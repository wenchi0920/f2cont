<?
# 禁止直接访问该页面
if (basename($_SERVER['PHP_SELF']) == "keywords_add.inc.php") {
...
function onclick_update(form) {
	...
	if (isNull(form.linkUrl, '<?=$strErrNull?>')) return false;
            ...
            <div class="subcontent">
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="90%">
                    <input name="linkUrl" id="linkUrl" class="textbox" type="TEXT" size=50 value="<?=$linkUrl?>">
                  </td>
                </tr>
                <tr>
                  <td width="10%" nowrap>
                  ...
                  <td width="90%">
                    <input name="linkImage" id="linkImage" class="textbox" type="file" size=50 maxlength=20>
                  </td>
                </tr>
              </table>
            </div>
