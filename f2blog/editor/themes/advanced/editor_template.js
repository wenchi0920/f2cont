...
var TinyMCE_AdvancedTheme = {
	...
	_buttons : [
		...
		['pmcode', 'pcode.gif', 'lang_theme_pcode_desc', 'pmcode'],
	...
	_buttonMap : 'anchor,backcolor,bold,bullist,charmap,cleanup,code,copy,cut,forecolor,help,hr,image,indent,italic,justifycenter,justifyfull,justifyleft,justifyright,link,newdocument,numlist,outdent,paste,redo,removeformat,strikethrough,sub,sup,underline,undo,unlink,visualaid,advhr,ltr,rtl,insertcode,emotions,flash,fullpage,fullscreen,iespell,insertdate,inserttime,insertcode,pastetext,pasteword,selectall,preview,print,save,replace,search,table,cell_props,delete_col,delete_row,col_after,col_before,row_after,row_before,merge_cells,row_props,split_cells,pmcode',
	...
	handleNodeChange : function(editor_id, node, undo_index, undo_levels, visual_aid, any_selection, setup_content) {
		...
		do {
			switch (node.nodeName) {
				...
				case "PMCODE":
					 tinyMCE.switchClass(editor_id + '_pmcode', 'mceButtonSelected');
				break;
