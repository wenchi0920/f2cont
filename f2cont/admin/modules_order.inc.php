...
<form action="" method="post" name="seekform">
  <div id="content">
	...
	<tr class="subcontent-title">
	  <td width="20%"><?php echo $strModName?></td>
	  <td width="80%"><?php echo $strModuleDescription?></td>
	</tr>
	</table>
	...
	?>
		<tr onClick="SelectRow(event)">
		  <td class="subcontent-td" width="20%"><input type="hidden" name="arrid[]" value="<?php echo $arr_parent[$i]['id']?>"><?php echo $arr_parent[$i]['name']?></td>
		  <td class="subcontent-td" width="80%"><?php echo $modTitle?></td>
		</tr>
	<?php }?>
	  </table>
	</div>
