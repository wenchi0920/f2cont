	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td class="searchtool">
		  ...
		  &nbsp;
		  <input name="exchange" class="btn" type="button" value="<?php echo $strLinksExchage?>"  onclick="confirm_submit('<?php echo $edit_url?>','order')">
		</td>
	  </tr>
	</table>
	<div class="subcontent">
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
		<tr class="subcontent-title">
		  ...
		  <td width="8%" class="whitefont" nowrap>
			<?php 
			echo "<a class=\"columntitle\" href=\"$order_url&page=$page&order=orderNo\">$strTagsOrderNo</a>";
			if ($order=="orderNo"){echo "<img src=\"themes/{$settingInfo['adminstyle']}/down.gif\" border=\"0\">";}
			?>
		  </td>
		  <td width="51%" class="whitefont" nowrap>
			<?php 
			echo "<a class=\"columntitle\" href=\"$order_url&page=$page&order=name\">$strlinkgroupName</a>";
		...
		<tr class="subcontent-input" onMouseOver="this.style.backgroundColor='<?php echo $settingInfo['mouseovercolor']?>'" onMouseOut="this.style.backgroundColor=''">
		  ...
		  <td nowrap class="subcontent-td">
			<?php echo ($fa['isSidebar']=="1")?$strYes:"<font color=blue>".$strNo."</font>"?>
		  </td>
		</tr>
		<?php }//end while?>
	  </table>
