      ...
      <TD vAlign=top width="100%"><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				  ...
				  <?php
					switch($step) {
						...
						case 3:
							...
							if (!file_exists("../attachments")){mkdir("../attachments", 0755);}
						...
						case 4:
							...
							$str.="    <td width='100%' valign='top'><input class='flat' type='text' name='table_prefix' size='40' value=\"f2cont_\" onFocus=\"setHelp('table_prefix')\" tabindex='6'></td>\n";
							$str.="    <td width='30'>&nbsp;</td>\n";
							$str.="  </tr>\n";
							$str.=$spec;
        ...
        <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
          <TBODY>
            ...
            <TR>
              <TD colspan=2>
			  <span style="font-size:11px"><p><center>Powered by F2Blog.cont. Version 1.0 build 11.30<br>CopyRight &copy; 2008 <a href='http://www.f2cont.com' target='_blank'>F2Cont.com</a> All Rights Reserved.</center></p></span>
			  </TD>
            </TR>
          </TBODY>
        </TABLE></TD>
