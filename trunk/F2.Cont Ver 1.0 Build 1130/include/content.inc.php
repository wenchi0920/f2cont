		...
		?>
			<div class="Content">
			  ...
			  <div id="log_<?php echo $key?>" <?php echo ($fa['isTop']==2)?"style=\"display:none\"":""?>>
				<div class="Content-body" id="logcontent_<?php echo $fa['id']?>" style="table-layout: fixed;">
					<?php 
					...
					if ($fa['password']!="" && (strpos(";".$_SESSION['logpassword'],$fa['password'])<1) && $_SESSION['rights']!="admin"){
						echo "<img src=\"images/icon_lock.gif\" alt=\"\"/> $strLogPasswordHelp<br/><br/> \n";
					?>
				...
				<div class="Content-bottom">
				  ...
				  <div class="ContentBRight"></div>
					  ...
					  <?php if (!empty($_SESSION['rights']) && $_SESSION['rights']!="member" && ($_SESSION['rights']=="admin" || $fa['author']==$_SESSION['username']) && false){ ?>
						<select name="action" id="action" onchange="javascript:comfirm_manager(this.options[this.selectedIndex].value,'<?php echo $base_rewrite;?>admin/logs.php?mark_id=<?php echo $fa['id']?>&amp;action=manage&amp;manage=')">
			  ...
			  <table cellpadding="2" cellspacing="2" width="100%">
				<tr>
				  <td valign="top">
					...
					<a href="<?php echo $readlogs_url.$fa['id'].$settingInfo['stype']?>" title="<?php echo $strAuthor.":".$author."&nbsp;".$strLogDate.":".format_time($settingInfo['currFormatDate'],$fa['postTime'])?>">
