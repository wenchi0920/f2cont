...
<br /><br />
   <div style="text-align:center;">
    <div id="MsgContent" style="width:600px">
		  ...
		  ?>
			  <table width="100%" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					...
					<td align="left" style="padding:3px;">
						<input name="oldpassword" type="password" size="30" class="userpass" maxlength="20"/><font color="#FF0000">&nbsp;*</font> <?php echo $strOldPasswordDesc?>
					</td>
				  </tr>
				  <?php  } ?>
				  <tr>
					<td align="right"><strong><?php echo $strNewLoginPassword?>:</strong></td>
					<td align="left" style="padding:3px;">
